          ...
          <div class="p-5 bg-[#F5F5F5] rounded w-[70%] m-auto">
            ...
            <div class="relative mt-4">
              ...
              <div class="relative mt-4">
                ...
                <p class="text-[14px] text-red-500"></p>
              </div>
              <div class="relative mt-4">
                <label
                  class="block text-label text-gray-700 text-lg mb-1 flex text-nowrap"
                  for="password"
                >
                  Confirm Password <span class="text-red-600 ml-2">*</span>
                </label>
                <input
                  :type="showpassword"
                  @change="is_not_fill_password = false"
            ...
            <button  value="Login" class="bg-[#4CC552] text-white py-2 w-full rounded focus:outline-primary focus:shadow-outline mt-4 text-[1.2rem]"
            @click="userLogin"
            >
              Sign Up
            </button>
            <p class="text-gray-800 mt-6 text-center">
              ...
              <router-link to="/login" class="text-blue-600 hover:text-blue-700 focus:text-blue-700 transition duration-200 ease-in-out"
              >Login</router-link>
            </p>
          </div>
        </div>
